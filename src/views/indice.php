...
<div class="elementos">
    <div class="fila">
        ...
        <div class="columna-imagen">
            <img src="template/img/index/elemento1.png" alt="imagen1">
        </div>
    </div>
</div>
<div class="elementos">
    <div class="fila">
        <div class="columna-imagen">
            <img src="template/img/index/elemento2.png" alt="imagen2">
        </div>
        <div class="columna-texto">
...
<div class="elementos">
    <div class="fila">
        ...
        <div class="columna-imagen">
            <img src="template/img/index/elemento3.png" alt="imagen3">
        </div>
    </div>
</div>
<div class="elementos">
    <div class="fila">
        <div class="columna-imagen">
            <img src="template/img/index/elemento4.png" alt="imagen4">
        </div>
        <div class="columna-texto">
